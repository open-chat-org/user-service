...
type UserServiceClient interface {
	UpdateAvatar(ctx context.Context, in *Avatar, opts ...grpc.CallOption) (*Empty, error)
	UpdateProfile(ctx context.Context, in *Profile, opts ...grpc.CallOption) (*Empty, error)
...
func (c *userServiceClient) UpdateAvatar(ctx context.Context, in *Avatar, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/pb.UserService/UpdateAvatar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) UpdateProfile(ctx context.Context, in *Profile, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/pb.UserService/UpdateProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	UpdateAvatar(context.Context, *Avatar) (*Empty, error)
	UpdateProfile(context.Context, *Profile) (*Empty, error)
...
func (UnimplementedUserServiceServer) UpdateAvatar(context.Context, *Avatar) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAvatar not implemented")
}
func (UnimplementedUserServiceServer) UpdateProfile(context.Context, *Profile) (*Empty, error) {
...
func _UserService_UpdateAvatar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/UpdateAvatar",
	}
...
func _UserService_UpdateProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/UpdateProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
